...
describe 'testing friendship features', type: :feature do
  before :each do
    @test_friend = User.create!({ name: 'karthy',
                                  email: 'karthylock02@gmail.com',
                                  password: '000000',
  ...
  ## Creating
  describe 'Performing actions as karthy' do
    before :each do
      visit 'users/sign_in'
      fill_in 'Email', with: 'karthylock02@gmail.com'
      fill_in 'Password', with: '000000'
      click_button 'Log in'
      visit 'users'
    end
    it 'login was made' do
      expect(page).to have_content 'karthy'
    end
