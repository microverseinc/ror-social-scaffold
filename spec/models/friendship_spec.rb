...
RSpec.describe Friendship, type: :model do
  before(:all) do
    @user1 = User.create(id: 1, name: 'Ismael', email: 'ismael@gmail.com', password: '123456', password_confirmation: '123456')
    @friend = User.create(id: 2, name: 'Ixboy', email: 'ixboy@gmail.com', password: '123456', password_confirmation: '123456')
