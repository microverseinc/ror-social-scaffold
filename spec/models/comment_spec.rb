...
RSpec.describe Comment, type: :model do
  context "validations tests" do
   ...
   let(:post_params) { { content:'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Morbi molestie lobortis diam, ac luctus massa lacinia non. Curabitur cursus elementum sem, fermentum porta lectus tristique sed. Phasellus vita' } }
